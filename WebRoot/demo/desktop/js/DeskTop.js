...
mini.extend(mini.ux.DeskTop, mini.Control, {
    ...
    _create: function () {
        ...
        this.viewportEl = this.el.firstChild;
        this.taskbarEl = this.el.lastChild;
        this.modulesEl = this.viewportEl.firstChild;
    ...
    doLayout: function () {
        this.viewportEl.style.height = this.getViewportHeight() + "px";
        this._doUpdateModules();

        mini.layout(this.viewportEl);
    },
    ...
    createWindow: function (type) {
        ...
        //create
        var win = new type();
        win.containerEl = this.viewportEl;
        win.render(this.viewportEl);        
