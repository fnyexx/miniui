...
public class TestDB {
	...
	public static String url = "jdbc:mysql://localhost/miniui_test?useUnicode=true&characterEncoding=GBK";
...
+"where a.name like '%" + key + "%' \n";
    ...
    public String InsertEmployee(HashMap user) throws Exception
    {
        ...
        if (StringUtil.isNullOrEmpty(user.get("gender").toString())) user.put("gender", 0);
